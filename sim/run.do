...
# Log/Wave files
# ==========================================
file mkdir results/$testname
set logfile "./results/$testname/${testname}.log"
set wavefile "./results/$testname/${testname}.wlf"
set qwavefile "./results/$testname/qwave.db"
set complog "./results/$testname/comp.log"
