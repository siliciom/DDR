// ----------------------------------------------------------------------------------------------------
// Component    : ddr_wr_bst_intlv_bl4_100_seq
// Test Owner   : Parikshith
//
// Description  :  Burst termination  sequence for Burst Length = 4.
//
// Sequence Flow:
//   1. IDLE
...
class ddr_wr_bst_intlv_bl4_100_seq extends uvm_sequence #(DDR_seq_item);

  `uvm_object_utils(ddr_wr_bst_intlv_bl4_100_seq)
  ...
  function new(string name = "ddr_wr_bst_intlv_bl4_100_seq");
    super.new(name);
  endfunction
