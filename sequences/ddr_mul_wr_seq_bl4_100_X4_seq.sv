class ddr_mul_wr_seq_bl4_100_X4_seq extends uvm_sequence #(DDR_seq_item);
  `uvm_object_utils( ddr_mul_wr_seq_bl4_100_X4_seq )
  ...
  function new(string name ="ddr_mul_wr_seq_bl4_100_X4_seq");
    super.new(name);
  endfunction
