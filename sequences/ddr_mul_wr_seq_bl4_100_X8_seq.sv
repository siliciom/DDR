class ddr_mul_wr_seq_bl4_100_X8_seq extends uvm_sequence #(DDR_seq_item);
  `uvm_object_utils( ddr_mul_wr_seq_bl4_100_X8_seq )
  ...
  function new(string name ="ddr_mul_wr_seq_bl4_100_X8_seq");
    super.new(name);
  endfunction
