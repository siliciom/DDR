// Component    : ddr_mul_wr_seq_bl8_100_X8_seq
// Test Owner   : Parikshith
//
// Description  :
//   DDR multiple WRITE/READ sequence for Sequential Burst Length = 8 (x8).
//
//   Sequence Flow:
//     1. IDLE
...
//   sequential burst on an x8 DDR device.
//

class ddr_mul_wr_seq_bl8_100_X8_seq extends uvm_sequence #(DDR_seq_item);

  `uvm_object_utils(ddr_mul_wr_seq_bl8_100_X8_seq)
  ...
  function new(string name = "ddr_mul_wr_seq_bl8_100_x8_seq");
    super.new(name);
  endfunction
